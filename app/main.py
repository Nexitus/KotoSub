    ...
    def run_process():
        try:
            ...
            result = translator.process(
                ...
                local_llm_file=config_data.get("localLlmFile"),
                transcription_provider=config_data.get("transcriptionProvider", "openai"),
                translation_provider=config_data.get("translationProvider", "openai"),
                ...
                use_gpu_encoding=config_data.get("useGpuEncoding", False),
                burn_options={
